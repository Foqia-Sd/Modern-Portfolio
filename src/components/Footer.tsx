...
const Footer = () => {
  ...
  return (
    <footer className="w-full py-12 px-4 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <motion.div
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              {[
                ...
                <Link 
                  ...
                  className="text-gray-600 dark:text-gray-300 hover:text-blue-500 
                    dark:hover:text-blue-400 transition-colors duration-200 w-fit"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              © {currentYear} Foqia Siddiqui. All Rights Reserved.
            </p>
          </div>
        </div>
      </motion.div>
